...
export default function ViewMonthlyExpenses({navigation:nav}:any){
  const months = [
  ...
  return (
    <View style={styles.Container}>
        ...
        <Text style={styles.Header}>{months[date.getMonth()]} Expenses</Text>
      ...
      <View style={styles.Container}>
      <Text style={styles.SubTopic2}>{`Total Expenses: Rs.${totalExpenses}.00`}</Text>
      </View>
